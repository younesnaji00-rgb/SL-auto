...
export default function StepDocuments({ scanFiles, onScanFilesChange }: StepDocumentsProps) {
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
      <div className="text-center space-y-2">
        ...
        <p className="text-sm text-muted-foreground max-w-lg mx-auto">
          Importez vos documents à scanner. L'IA les analysera pour pré-remplir le formulaire automatiquement.
        </p>
      </div>
      ...
      <Card className="border-blue-200 dark:border-blue-800">
        ...
        <CardContent>
          <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-blue-300 dark:border-blue-700 rounded-lg cursor-pointer bg-blue-50/30 dark:bg-blue-950/20 hover:bg-blue-50/60 dark:hover:bg-blue-950/40 hover:border-blue-400 transition-all group">
            ...
            <input type="file" multiple accept=".pdf,.png,.jpg,.jpeg,.webp" className="hidden" onChange={handleFileSelect} />
          </label>
      ...
      <div className="flex items-start gap-3 p-4 rounded-lg bg-blue-50/50 dark:bg-blue-950/20 border border-blue-200 dark:border-blue-800">
        ...
        <div className="text-sm space-y-1">
          ...
          <p className="text-blue-600/80 dark:text-blue-400/70">
            Cliquez <strong>"Scanner & Continuer"</strong> pour lancer l'analyse IA sur les documents,
            ou <strong>"Passer le scan"</strong> pour remplir manuellement. Tous les documents seront sauvegardés avec le dossier.
          </p>
        </div>
      </div>
    </div>
