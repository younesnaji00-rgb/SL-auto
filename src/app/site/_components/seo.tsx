...
export const softwareJsonLd = {
  ...
  applicationSubCategory: 'Auto damage appraisal management software',
  operatingSystem: 'Web, Android',
  description:
    'Appraisal management and claims workflow software for independent auto damage appraisal firms: insurer assignments, field appraiser app, photo documentation, supplements, total loss and appraisal reports in one claim file.',
  url: absoluteUrl('/site'),
  audience: { '@type': 'BusinessAudience', audienceType: 'Independent auto damage appraisal firms and appraisers' },
  offers: { '@type': 'Offer', price: '0', priceCurrency: 'CAD', description: 'Free interactive demo, no account required' },
  featureList: [
    'Insurer assignment intake with AI document pre-fill',
    'Field appraiser mobile app with photo documentation (before, during, after repair)',
    'Line-by-line damage estimates, supplements and agreement revisions',
    'Total loss and repairable vehicle workflows',
    'Appraisal report and fee note generation',
    'Cycle-time monitoring and overdue tracking per appraiser',
    'Complete per-claim audit history',
