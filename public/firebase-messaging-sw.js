...
// White-label support: the page registers this SW with the active project's
// config in the query string (see src/firebase/sw-url.ts). Fall back to the
// original production project when absent.
const swParams = new URLSearchParams(self.location.search);
firebase.initializeApp({
  apiKey: swParams.get('apiKey') || 'AIzaSyCVP_zYN5n2MI-tXjbcknQS1DGqOHCYZ2U',
  authDomain: swParams.get('authDomain') || 'studio-9568416614-6523a.firebaseapp.com',
  projectId: swParams.get('projectId') || 'studio-9568416614-6523a',
  storageBucket: swParams.get('storageBucket') || 'studio-9568416614-6523a.firebasestorage.app',
  messagingSenderId: swParams.get('messagingSenderId') || '588304904574',
  appId: swParams.get('appId') || '1:588304904574:web:26b8dd1d7f19241c7c832f',
});
